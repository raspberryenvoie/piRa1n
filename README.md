...
piRa1n will be automatically restart after every Jailbreak and won't shutdown. Run this command: `mv /home/pi/piRa1n/piRa1n_no_automatic_shutdown.sh /home/pi/piRa1n/piRa1n.sh` and restart piRa1n `sudo service piRa1n restart`.

If you want to restore the default behavior (automatically shutdown Pi after every Jailbreak): `mv /home/pi/piRa1n/piRa1n_automatic_shutdown.sh /home/pi/piRa1n/piRa1n.sh` and restart piRa1n `sudo service piRa1n restart`.
