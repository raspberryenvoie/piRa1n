...
`sudo apt update && sudo apt upgrade -y &&  sudo apt install usbmuxd -y && cd /home/pi && git clone https://github.com/raspberryenvoie/piRa1n.git && sudo chmod +x install_piRa1n.sh update_checkra1n && ./install_piRa1n.sh`
