...
Connect the Raspberry Pi 4/Banana pi M2 Zero to a powerbank. After that, plug you iDevice to the Pi, put it into recovery mode, then into DFU mode and let piRa1n do the rest!
